...
const Navigation = () => {
    return (
        ...
        <div
        className="w-full px-5 md:px-32 py-4 flex items-center justify-between absolute bg-black md:bg-gradient-to-b from-black to-black/5">
        
        <button className="brightness-125">
            <img className="h-8 md:h-10 w-auto px-0 mx-0" src="/storage/app/public/icon2.png"
                alt="Your Company" />
        </button>
        ...
        <div className="gap-5 items-center w-1/6 justify-between hidden md:flex">
            ...
            <button className="hidden md:block"><img src="{{Vite::asset('storage/app/public/profils/img7.png')}}" alt=""
